...
**主 logo 为红色横版**（`etna-horizontal-red.png`）。所有场景默认使用红色横版；竖版仅作为方形版位的变体。

| 组合 | 说明 | 使用场景 |
|---|---|---|
| **横版** | ETNALabs 单行连写 | **主 logo。** 所有场景默认使用；网站页眉、文档页眉/页脚、邮件签名、PPT、报告 |
| **竖版** | ETNA 上 / Labs 下 | 变体。仅用于头像、印章、方形版位 |
| **横版 + tagline** | ETNALabs / Deep Conviction. Long View. | 名片、PPT 首页、封面 |

每种组合各有 **红 / 黑 / 白** 三个色版。**横版和竖版都优先选红色版**；黑版仅用于单色印刷等无法用色的场景，白版仅用于深色底或 Etna Red 底。
